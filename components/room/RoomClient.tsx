...
const RoomClient = ({ paramsRoomCode }: { paramsRoomCode: string }) => {
    const roomCode = Number(paramsRoomCode);
    ...
    if (!createdRoom) {
        joinRoomAction({ displayName, roomCode });
        console.log("there was no createdRoom so i ran joinRoomAction")
    }
  return (
    <div>
